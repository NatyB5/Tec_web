...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (createUserDto, isAdmin) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, this.prisma.uSUARIO.create({
                                    data: __assign(__assign({}, createUserDto), { senha: hashedPassword, creditos: new client_1.Prisma.Decimal(0.0), is_admin: isAdmin }),
                                    select: {
                                        id_usuario: true,
                                        nome: true,
                                        email: true,
        ...
        UsersService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.uSUARIO.findMany({
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!updateUserDto.senha) return [3 /*break*/, 2];
                            _a = data;
                            return [4 /*yield*/, bcrypt.hash(updateUserDto.senha, 10)];
                        case 1:
                            _a.senha = _b.sent();
                            _b.label = 2;
                        case 2: return [2 /*return*/, this.prisma.uSUARIO.update({
                                where: { id_usuario: id },
                                data: data,
                                select: {
                                    id_usuario: true,
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.prisma.uSUARIO.delete({ where: { id_usuario: id } })];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        UsersService_1.prototype.rechargeCredits = function (userId, amount) {
            return __awaiter(this, void 0, void 0, function () {
                var updatedUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            updatedUser = _a.sent();
                            return [2 /*return*/, {
                                    message: "Recarga de ".concat(amount, " cr\u00E9ditos realizada com sucesso para ").concat(updatedUser.nome, "."),
