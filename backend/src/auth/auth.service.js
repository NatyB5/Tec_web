...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(prisma, jwtService, usersService) {
            this.prisma = prisma;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, bcrypt.compare(loginDto.senha, user.senha)];
                        case 2:
        ...
        AuthService_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.usersService.create(createUserDto, false)];
                });
            });
        };
        AuthService_1.prototype.getUserFromToken = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
