...
var RoomsController = function () {
    var _classDecorators = [(0, common_1.Controller)('rooms')];
    ...
    var RoomsController = _classThis = /** @class */ (function () {
        function RoomsController_1(roomsService) {
        ...
        RoomsController_1.prototype.create = function (createRoomDto) {
            return this.roomsService.create(createRoomDto);
        };
        RoomsController_1.prototype.update = function (id, updateRoomDto) {
            return this.roomsService.update(id, updateRoomDto);
        };
        RoomsController_1.prototype.remove = function (id) {
            return this.roomsService.remove(id);
        };
        // Rotas abaixo são abertas para usuários logados
        RoomsController_1.prototype.findAll = function () {
            return this.roomsService.findAll();
        };
        RoomsController_1.prototype.findOne = function (id) {
            return this.roomsService.findOne(id);
        };
        return RoomsController_1;
    }());
